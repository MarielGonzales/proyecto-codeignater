    ...
    <table class="table table-striped table-bordered">
        ...
        <?php foreach($hospitalizaciones as $h): ?>
            <tr>
                ...
                <td>
                    <a href="<?= site_url('hospitalizaciones/editar/'.$h['id']) ?>" class="btn btn-warning btn-sm">Editar</a>
                    <a href="<?= site_url('hospitalizaciones/eliminar/'.$h['id']) ?>" class="btn btn-danger btn-sm"
